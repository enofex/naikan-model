...
class JsonDeserializerTest {
    ...
    void shouldDeserializeValidModel() throws DeserializerException {
        ...
        assertAll(
                ...
                () -> assertEquals("Naikan Software Engineering", bom.developers().all().get(0).department()),
                ...
                () -> assertEquals("https://www.edgetag.tech", bom.developers().all().get(0).organizationUrl()),
                ...
                () -> assertEquals("Best programming language", bom.technologies().all().get(0).description()),

                () -> assertEquals(1, bom.licenses().all().size()),
                () -> assertEquals("Apache-2.0", bom.licenses().all().get(0).name()),
                () -> assertEquals("https://www.apache.org/licenses/LICENSE-2.0.txt", bom.licenses().all().get(0).url()),
                ...
                () -> assertEquals("http://127.0.0.1/bitbucket/naikan", bom.integrations().all().get(0).url()),
                ...
                () -> assertEquals("http://127.0.0.1:8080/bamboo/naikan", bom.integrations().all().get(1).url()),
                ...
                () -> assertEquals(LocalDateTime.parse("2022-12-28T08:29:10.079226"), bom.deployments().all().get(0).timestamp())
        );
    }
}
